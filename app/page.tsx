...
const intelligence: Intelligence[] = [
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "超商御飯糰也中？發票App推新功能「食安快篩」 一票測完見暗紅畫面驚呆：根本吃毒達人 - Yahoo新聞",
    summary: "食品安全與品質與品質管控事件：'超商御飯糰也中？發票App推新功能「食安快篩」 一票測完見暗紅畫面驚呆：根本吃毒達人 - Yahoo新聞'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "Yahoo新聞",
    url: "https://news.google.com/rss/articles/CBMi_?oc=5",
    priority: "高",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "政院：食安法修法納10大重點加重隱匿通報處罰| 政治 - 中央社 CNA",
    summary: "食品安全與品質與品質管控事件：'政院：食安法修法納10大重點加重隱匿通報處罰| 政治 - 中央社 CNA'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "中央社 CNA",
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/23 15:50。</p>
            </div>
