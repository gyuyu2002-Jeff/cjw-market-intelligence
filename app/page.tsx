...
const intelligence: Intelligence[] = [
{
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "召回背後：如何報導食品安全故事 - 醫療保健記者協會",
    summary: "食品安全與品質與品質管控事件：'召回背後：如何報導食品安全故事 - 醫療保健記者協會'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "〈毒油食安風暴〉共7批次不合格！食安法祭10大重拳修正 將增訂中央指揮機制 - news.cnyes.com",
    summary: "食品安全與品質與品質管控事件：'〈毒油食安風暴〉共7批次不合格！食安法祭10大重拳修正 將增訂中央指揮機制 - news.cnyes.com'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "news.cnyes.com",
    url: "https://news.google.com/rss/articles/CBMiT0FVX3lxTE5KRDgyam4za0daMnpCNlV2ckZTcERQV09OQlUwYlNyN0Z0dGVQTG1uS2R4UDVkWXV3LTE4bzBzUzVBZzl0Wk9zaG9pUlpGNDQ?oc=5",
    priority: "高",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="newspaper-masthead">
          ...
          <div className="masthead-meta">
            <div className="date-line">
              <p className="eyebrow">2026年7月30日・星期四</p>
            </div>
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-07-30T03:40:47+08:00">2026/07/30 03:40</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/30 03:40。</p>
            </div>
