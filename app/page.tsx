...
const marketPulse = [
  {
    region: "台灣", signal: "分化", note: "體驗升級與食安重整", value: 72,
    headline: "蔬食轉向精緻體驗與彈性客群，食安風暴重塑供應鏈。",
    drivers: ["策展思維與精緻餐飲帶動彈性蔬食客群，打破傳統素食刻板印象。", "油品與寄生蟲等食安事件爆發，促使大眾要求源頭透明與科學風管。", "抗藥性與動物蛋白疑慮升溫，推動消費者轉向無藥殘植物基替代品。"],
    opportunity: "主打潔淨標示與源頭透明度，結合策展化與跨界異國風味研發，精準切入佔市場大多數的彈性蔬食客群。",
    risk: "油品與添加物食安風暴引發消費疑慮，加工味重或標示不清的產品面臨合規成本增加與信任危機。",
    watch: ["彈性蔬食人口滲透率與跨界餐飲合作動向", "政府食用油品與生鮮農產品源頭監測與法規修訂", "植物基產品之潔淨標示與透明化追溯進展", "消費大眾對食品安全風險評估觀念之接受度"],
  },
  {
    region: "美國", signal: "分化", note: "潔淨標示與理性重整", value: 72,
    headline: "美國市場進入理性轉型期，潔淨標示與質感決定勝負。",
    drivers: ["彈性素食族群擴大帶動多樣化蛋白與即食料理強勁需求。", "技術突破聚焦於風味遮蔽、質地模擬與微加工配方優化。", "高達六成家庭滲透率，但區域市場消費偏好呈現顯著差異。"],
    opportunity: "針對北美美西與中西部之區域偏好，主打潔淨標示原型食物，結合菇類與豆類開發高質感的微加工亞洲風味即食料理。",
    risk: "過度加工產品面臨理性消費者淘汰，且各州區域通路偏好與價位敏感度差異大，若缺乏精準佈局易致鋪貨效益不如預期。",
    watch: ["潔淨標示（Clean Label）產品之消費者回購率", "美西、美南與中西部區域通路之品類滲透率差異", "蕈菇、海藻等新興植物蛋白原料之成本與供應鏈穩定度", "主要替代肉品牌之價格合理化與感官技術突破進展"],
  },
  {
    region: "澳洲", signal: "分化", note: "原型轉型與價值重整", value: 48,
    headline: "通膨抑制高加工植物肉需求，市場轉向原型健康與潔淨標籤",
    drivers: ["生活成本與通膨壓力持續，消費者轉向高 CP 值與傳統肉類。", "高度加工與口感未達預期，促使需求轉向原型食材與潔淨標籤。", "零售通路下架非核心商品與新創清算，產業進入洗牌整合期。"],
    opportunity: "聚焦天然無添加、高蛋白的原型植物食材開發，主打高 CP 值與真實美味，並擴展植物起司等高潛力品類以切入健康潔淨市場。",
    risk: "大型連鎖超市精簡上架品項導致通路門檻提高，加上通膨侵蝕消費力與競爭同業資產重組帶來的價格戰風險。",
    watch: ["Woolworths 等主導通路之品項淘汰與上架標準", "潔淨標籤（Clean Label）與原型食物之消費佔比", "澳洲植物蛋白與植物乳製品（起司/優格）創新動態", "主要植物肉品牌之價格調整與併購重組趨勢"],
  },
  {
    region: "歐洲", signal: "分化", note: "法規限縮與原型轉型", value: 75,
    headline: "歐洲植物基市場持續成長，面臨命名法規與原型飲食轉型。",
    drivers: ["彈性素食人口持續增加與環保永續意識抬頭，驅動長期市場擴張。", "消費者偏好從過度加工仿肉轉向天然原型、潔淨標示與高營養食品。", "乳製品替代品與多元植物基零食需求強勁，拓展整體市場邊界。"],
    opportunity: "應順應潔淨標示與原型食物趨勢，開發高營養、低加工且不依賴傳統肉類名稱的創新植物基產品或零食，搶占非仿肉類市場。",
    risk: "歐盟擬禁止使用「漢堡」、「香腸」等肉類命名，將大幅增加產品包裝重製與行銷成本，且過度加工產品逐漸失去消費者青睞。",
    watch: ["歐盟植物基食品肉類命名禁令法案之最終審議與立法進度", "潔淨標示（Clean Label）與原型植物食品的市場滲透率", "通膨環境下歐洲零售與餐飲通路的植物基產品價格敏感度", "非肉類替代品（植物奶、植物基零食等）的品類成長動能"],
  }
];

const dailyBriefing = {
  title: "植物基飲食去標籤化，競爭焦點轉向<strong>美味體驗與潔淨標章。</strong>",
  subtitle: "全球植物基市場加速向彈性素食者靠攏。趨勢顯示消費者已跨越擬真素肉階段，轉向追求天然原型食材、潔淨標章與精緻風格美學體驗。",
  decisionTitle: "告別傳統加工仿肉，轉向潔淨原型與風格體驗。",
  decisionDetail: "非素食彈性客群已成消費主力，美味與無添加為關鍵考量。研發應減少高度加工，並導入策展思維提升品牌風格。"
};
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-08-07T00:23:28+08:00">2026/08/07 00:23</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/08/07 00:23。</p>
            </div>
