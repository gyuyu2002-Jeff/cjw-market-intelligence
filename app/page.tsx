...
const intelligence: Intelligence[] = [
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "食安可放寬 信任不能打折 | 社論 | 專欄 - 經濟日報",
    summary: "食品安全與品質與品質管控事件：'食安可放寬 信任不能打折 | 社論 | 專欄 - 經濟日報'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "經濟日報",
    url: "https://news.google.com/rss/articles/CBMiWkFVX3lxTFA3UldQWHJIaTdKWFFFTzFleXlINzlRTmpHMzlvZkJ0Z2U5cHB4ZjAtS1RkUXBQWmo3OVptWkdaU083UlFIVkx4YVhNSkxOcDNhaEtxV1FMcVRodw?oc=5",
    priority: "高",
    publishedAt: "2026-07-21",
    collectedAt: "2026-07-25",
    score: 85,
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-07-25T23:28:54+08:00">2026/07/25 23:28</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/25 23:28。</p>
            </div>
