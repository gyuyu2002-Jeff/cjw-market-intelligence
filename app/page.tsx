  ...
  },
{
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "新墨西哥州立大學食品安全實驗室轉變為首要創新中心 - 新墨西哥州立大學",
    summary: "食品安全與品質與品質管控事件：'新墨西哥州立大學食品安全實驗室轉變為首要創新中心 - 新墨西哥州立大學'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "油品食安危機延燒！網點名1企業「完美躲過」 掀兩派熱議 - UDN",
    summary: "食品安全與品質與品質管控事件：'油品食安危機延燒！網點名1企業「完美躲過」 掀兩派熱議 - UDN'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "UDN",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "Krishnamoorthi 重新引入嬰兒食品安全法，對嬰幼兒食品中的有毒金屬設定可執行限制 - krishnamoorthi.house.gov",
    summary: "食品安全與品質與品質管控事件：'Krishnamoorthi 重新引入嬰兒食品安全法，對嬰幼兒食品中的有毒金屬設定可執行限制 - krishnamoorthi.house.gov'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "krishnamoorthi.house.gov",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-08-01T13:45:55+08:00">2026/08/01 13:45</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/08/01 13:45。</p>
            </div>
