  ...
  },
{
  ...
  },
  {
    ...
    region: "台灣",
    topic: "市場趨勢",
    title: "在市場裡做蔬食法餐？高雄鹽埕市場裡的純素法餐秘密基地「The Borage」 - foodnext.net",
    summary: "2025-05-14 07:00，foodnext.net發布一則來自taiwan的市場趨勢情報，主題為「在市場裡做蔬食法餐？高雄鹽埕市場裡的純素法餐秘密基地「The Borage」 - foodnext.net」。從標題可辨識的關鍵訊號包括市場，顯示事件與市場趨勢相關；目前僅依 RSS 標題與來源欄位整理，仍應點擊原始連結核對完整內容。",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "市場趨勢",
    title: "慈濟60週年「微光食刻」蔬食市集7/3華山開跑 50家品牌、台味到異國料理一次體驗 - foodnext.net",
    summary: "2026-07-03 07:00，foodnext.net發布一則來自taiwan的市場趨勢情報，主題為「慈濟60週年「微光食刻」蔬食市集7/3華山開跑 50家品牌、台味到異國料理一次體驗 - foodnext.net」。從標題可辨識的關鍵訊號包括相關市場訊號，顯示事件與市場趨勢相關；目前僅依 RSS 標題與來源欄位整理，仍應點擊原始連結核對完整內容。",
    impact: "市場訊號顯示需求、價格或通路正在變化，齋滋味應以實際回購與使用情境驗證，而非只追逐單一話題。",
    action: "持續追蹤價格、通路與消費者需求訊號，將具一致性的變化納入下一季產品與業務規劃。",
    owner: "產品研發",
    source: "foodnext.net",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "市場趨勢",
    title: "從剪髮到蔬食餐桌 「啼岸」用美學實踐零殘忍的生活日常 - foodnext.net",
    summary: "2025-10-29 07:00，foodnext.net發布一則來自taiwan的市場趨勢情報，主題為「從剪髮到蔬食餐桌 「啼岸」用美學實踐零殘忍的生活日常 - foodnext.net」。從標題可辨識的關鍵訊號包括相關市場訊號，顯示事件與市場趨勢相關；目前僅依 RSS 標題與來源欄位整理，仍應點擊原始連結核對完整內容。",
    impact: "市場訊號顯示需求、價格或通路正在變化，齋滋味應以實際回購與使用情境驗證，而非只追逐單一話題。",
    action: "持續追蹤價格、通路與消費者需求訊號，將具一致性的變化納入下一季產品與業務規劃。",
    owner: "產品研發",
    source: "foodnext.net",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="newspaper-masthead">
          ...
          <div className="masthead-meta">
            <div className="date-line">
              <p className="eyebrow">2026年9月14日・星期一</p>
            </div>
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-09-14T07:53:01+08:00">2026/09/14 07:53</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 06:00 檢查公開評價與品牌提及；Google 評論最近查核：2026/09/14 07:53。</p>
            </div>
