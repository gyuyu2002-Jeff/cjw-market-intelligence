  ...
  },
{
  ...
  },
  {
    ...
    summary: "2025-06-12 07:00，食力 foodNEXT發布一則來自taiwan的市場趨勢情報，主題為「Oatbedient 奇亞籽即溶燕麥奶 素食、乳糖不耐最安心的飲品選擇 - 食力 foodNEXT」。從標題可辨識的關鍵訊號包括相關市場訊號，顯示事件與市場趨勢相關；目前僅依 RSS 標題與來源欄位整理，仍應點擊原始連結核對完整內容。",
    impact: "市場訊號顯示需求、價格或通路正在變化，齋滋味應以實際回購與使用情境驗證，而非只追逐單一話題。",
    action: "持續追蹤價格、通路與消費者需求訊號，將具一致性的變化納入下一季產品與業務規劃。",
    owner: "產品研發",
    source: "食力 foodNEXT",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="newspaper-masthead">
          ...
          <div className="masthead-meta">
            <div className="date-line">
              <p className="eyebrow">2026年9月19日・星期六</p>
            </div>
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-09-19T07:52:49+08:00">2026/09/19 07:52</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 06:00 檢查公開評價與品牌提及；Google 評論最近查核：2026/09/19 07:52。</p>
            </div>
