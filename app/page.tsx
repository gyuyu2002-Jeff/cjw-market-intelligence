  ...
  },
{
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "NMSU Food Safety Laboratory transforms into premier hub of innovation - New Mexico State University",
    summary: "食品安全與品質與品質管控事件：'NMSU Food Safety Laboratory transforms into premier hub of innovation - New Mexico State University'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "New Mexico State University",
    url: "https://news.google.?oc=5",
    priority: "高",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "主持食安會報 卓揆：落實各項監測從源頭守護食安、強化跨部會資源整合積極推動食農教育 - ey.gov.tw",
    summary: "食品安全與品質與品質管控事件：'主持食安會報 卓揆：落實各項監測從源頭守護食安、強化跨部會資源整合積極推動食農教育 - ey.gov.tw'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "ey.gov.tw",
    url: "https://news.google.com/rss/articles/CBMihwFBVV95cUxNTDVGdUI2SDlSMzh5VGU0eXVmRHJhTW13SWtUY1NCRjlYeWVlUm5veU9oOGk4LXZGRFVjX1pEWTZXbTV3V21JMWd3S1ducDlxV3NDeXd2a3BLVEJBMXVyVzVhcktFand5cVpmYlBocFFXVlcwRnZHT1RkdVBPN2ZwWjhyeFJCVDg?oc=5",
    priority: "高",
    publishedAt: "2026-06-24",
    collectedAt: "2026-08-01",
    score: 85,
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "毒油風暴 民眾凱道怒吼食安 - UDN",
    summary: "食品安全與品質與品質管控事件：'毒油風暴 民眾凱道怒吼食安 - UDN'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "UDN",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "端午食安把關！中市稽查88家業者、抽驗177件產品全數合格 - taichung.gov.tw",
    summary: "食品安全與品質與品質管控事件：'端午食安把關！中市稽查88家業者、抽驗177件產品全數合格 - taichung.gov.tw'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "taichung.gov.tw",
    url: "https://news.google.com/rss/articles/CBMiX0FVX3lxTE95ZlF6bFlSLUVVb1I1UFBXMGdtYW90NkhILU55RVZRdFQ4UFAwWmhndTUybEtRajdTdGJYcVdwcnhpTUliT2VLbzRNTWFQV0FTNnVFbVZvOGlEZzdlV3Jv?oc=5",
    priority: "高",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "臺北市食安心展╴從農場到餐桌 每一口都用心 - health.gov.taipei",
    summary: "食品安全與品質與品質管控事件：'臺北市食安心展╴從農場到餐桌 每一口都用心 - health.gov.taipei'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "health.gov.taipei",
    url: "https://news.google.com/rss/articles/CBMiYkFVX3lxTE9TenVvekRuWXAyQUFfT0dHUGcwTWNDVjNhSThLSlBORWtMUjFaU2VQOFNrbmRYejgxcGRBbkRnVzMwei1PeTJXZTZFeTFpRVFjdlhzMjhtV196RkF5SVEya3F3?oc=5",
    priority: "高",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "中市食安管理獲中央評比滿分！ 跨局處演練再強化食安防線 衛生局長：持續守護市民飲食安全 - taichung.gov.tw",
    summary: "食品安全與品質與品質管控事件：'中市食安管理獲中央評比滿分！ 跨局處演練再強化食安防線 衛生局長：持續守護市民飲食安全 - taichung.gov.tw'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "taichung.gov.tw",
    url: "https://news.google.com/rss/articles/CBMiX0FVX3lxTE8yZXVGX0paZFRWVUVQQnlrN2xCSl9pNFFJc2taZGprNXpTbnd6SkdPcXpscm15VTZoYTVoa2RMeWlyOXdJaVZRWkVYMmNIVjcydE90T19BUmVieHJoV1Z3?oc=5",
    priority: "高",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "NC cyclosporiasis outbreak tops 300 cases; farmers stress food safety - ABC11 News",
    summary: "食品安全與品質與品質管控事件：'NC cyclosporiasis outbreak tops 300 cases; farmers stress food safety - ABC11 News'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "ABC11 News",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-08-01T13:40:48+08:00">2026/08/01 13:40</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/08/01 13:40。</p>
            </div>
