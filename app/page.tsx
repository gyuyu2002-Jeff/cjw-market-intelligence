...
const intelligence: Intelligence[] = [
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "反駁「只驗1件」不實訊息！中市食安處用數據駁斥：光去年抽驗油廠30件 - taichung.gov.tw",
    summary: "食品安全與品質與品質管控事件：'反駁「只驗1件」不實訊息！中市食安處用數據駁斥：光去年抽驗油廠30件 - taichung.gov.tw'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "taichung.gov.tw",
    url: "https://news.google.com/rss/articles/CBMifkFVX3lxTE9wSE5NSDd2QURFVjhSWXp6R282RWhJX1BsYzNSaVRvZjJRT1ZVUTNnbVdBMHBkeGJZRmJlOUpCTDBJWldiai0ybFQ3XzctMTVKRlYyMHlIam1ydGZQSUJ0d1NvNy1OcXVGMWJRdXdmVW0weVhFdUtXSEJNc0FOdw?oc=5",
    priority: "高",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "競品",
    title: "響應世界地球日 大成集團推出兩大全新蔬食品牌 - winnews.com.tw",
    summary: "同業大廠最新動態：'響應世界地球日 大成集團推出兩大全新蔬食品牌 - winnews.com.tw'。此動作反映了素食產業競爭格局的最新進展。",
    impact: "分析同業大廠的市場佈局與產品定位，以制定我方的競爭防禦策略與產品研發策略。",
    action: "評估同業此項動作對我方主力產品線的潛在競爭影響。",
    owner: "產品研發",
  ...
  },
{
    ...
    region: "台灣",
    topic: "消費趨勢",
    title: "【懶人包】「世界無肉日」一起吃蔬食！7-ELEVEN抽近萬元餐券、全家首推杏仁國寶奶茶、萊爾富折扣輕鬆買！ - 食力 foodNEXT",
    summary: "這是一則關於蔬食與植物基市場趨勢與消費分析的新聞。標題為：'【懶人包】「世界無肉日」一起吃蔬食！7-ELEVEN抽近萬元餐券、全家首推杏仁國寶奶茶、萊爾富折扣輕鬆買！ - 食力 foodNEXT'。",
    impact: "密切關注此類市場趨勢變化，作為開發下一季度素食調味包或熟食產品的定位依據。",
    action: "追蹤此趨勢發展，評估是否納入下一階段產品規劃。",
    owner: "品牌行銷",
    source: "食力 foodNEXT",
    url: "https://news.google.com/rss/articles/CBMibkFVX3lxTE9SQVNJRkF4c3N1WHljeWpFVElCd1BoYlJrRklvSk5pV3ljaU1taXNBNDNCOXRGOVoyX21EWFZ0cklhZnZYTjhmUHBLS2lPWjdTeGVnMjZSelZiVGZMLVFDVHlqWGo0cHBkYy1WcTJB?oc=5",
    priority: "中",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-07-26T19:56:57+08:00">2026/07/26 19:56</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/26 19:56。</p>
            </div>
