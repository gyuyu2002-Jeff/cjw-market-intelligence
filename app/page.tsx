...
const intelligence: Intelligence[] = [
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "台政院明通過食安法修法 賴清德籲朝野回歸專業 - 大纪元",
    summary: "食品安全與品質與品質管控事件：'台政院明通過食安法修法 賴清德籲朝野回歸專業 - 大纪元'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "大纪元",
    url: "https://news.google.?oc=5",
    priority: "高",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "中聯問題油事件損失難以估計…業者：願以食安第一最後才是求償- 日報 - 工商時報",
    summary: "食品安全與品質與品質管控事件：'中聯問題油事件損失難以估計…業者：願以食安第一最後才是求償- 日報 - 工商時報'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "工商時報",
    url: "https://news.google.com/rss/articles/CBMiX0FVX3lxTE9NX2xndzZ3djczRkExX3FzVzNuX2U5RHdMd2JSaGExeUpvYnF1NDBSSDlLNUk0Z1poQ0VQa0pZUDltQ3VIeEsyemxsaTNFdXJERnRLS0dhV2Zra0FLdDlN?oc=5",
    priority: "高",
    publishedAt: "2026-07-22",
    collectedAt: "2026-07-23",
    score: 85,
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "致癌油事件延燒 何欣純偕綠營參選人提中彰投苗食安3共同政見 - 台灣好新聞",
    summary: "食品安全與品質與品質管控事件：'致癌油事件延燒 何欣純偕綠營參選人提中彰投苗食安3共同政見 - 台灣好新聞'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "台灣好新聞",
    url: "https://news.google.?oc=5",
    priority: "高",
    publishedAt: "2026-07-22",
    collectedAt: "2026-07-23",
    score: 85,
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "民進黨中彰投苗首長參選人 推食安聯防 - 自由時報",
    summary: "食品安全與品質與品質管控事件：'民進黨中彰投苗首長參選人 推食安聯防 - 自由時報'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "自由時報",
    url: "https://news.google.?oc=5",
    priority: "高",
    publishedAt: "2026-07-22",
    collectedAt: "2026-07-23",
    score: 85,
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "〈毒油食安風暴〉經部祭配套：油品足供不漲價、不合格7批銷毀、協助集體求償 - news.cnyes.com",
    summary: "食品安全與品質與品質管控事件：'〈毒油食安風暴〉經部祭配套：油品足供不漲價、不合格7批銷毀、協助集體求償 - news.cnyes.com'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "news.cnyes.com",
    url: "https://news.google.com/rss/articles/CBMiT0FVX3lxTE5IR3czaGF4cTFzSU5UVkR3OWNkSnRNaUM1eW5WbGluTUFVVkhtRlNLRkR4V3JQallQUDB0WEVYSDduZXFlUlBLT3dtWHZPSEU?oc=5",
    priority: "高",
    publishedAt: "2026-07-22",
    collectedAt: "2026-07-23",
    score: 85,
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "隨著食品安全受到關注，沙拉日成為受控環境農業的焦點； Leigh Bailey 評論 - AndNowUKnow",
    summary: "食品安全與品質與品質管控事件：'隨著食品安全受到關注，沙拉日成為受控環境農業的焦點； Leigh Bailey 評論 - AndNowUKnow'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "AndNowUKnow",
    url: "https://news.google.?oc=5",
    priority: "高",
    publishedAt: "2026-07-22",
    collectedAt: "2026-07-23",
    score: 85,
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "智慧感測正在重塑個人化食品安全 - Nature",
    summary: "食品安全與品質與品質管控事件：'智慧感測正在重塑個人化食品安全 - Nature'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "Nature",
    url: "https://news.google.com/rss/articles/CBMiX0FVX3lxTE1GNGRFd3ZMNC1xaVoyeWVhcUQ2bDdxV2JjdHhoNmFMT2tMNUdIajlZVlNjX2t5enN0OFdMZi05STdZVmY5a3BEVEJjMjItYXBjTmRIbGJhY3RvWWJPQ3l3?oc=5",
    priority: "高",
    publishedAt: "2026-07-21",
    collectedAt: "2026-07-23",
    score: 85,
    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-foot">
          <time dateTime="2026-07-23T08:30:45+08:00">2026/07/23 08:30</time>
        </div>
      </aside>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/23 08:30。</p>
            </div>
