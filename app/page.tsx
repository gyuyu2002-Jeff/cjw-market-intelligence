  ...
  },
{
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "食安法修法卓榮泰：業者須設第3方認證實驗室| 政治 - cna.com.tw",
    summary: "食品安全與品質與品質管控事件：'食安法修法卓榮泰：業者須設第3方認證實驗室| 政治 - cna.com.tw'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "cna.com.tw",
  ...
  },
  {
    ...
    region: "台灣",
    topic: "原料技術",
    title: "臺北市食安心展╴從農場到餐桌 每一口都用心 - 臺北市政府衛生局",
    summary: "食品安全與品質與品質管控事件：'臺北市食安心展╴從農場到餐桌 每一口都用心 - 臺北市政府衛生局'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "臺北市政府衛生局",
  ...
  },
{
    ...
    region: "台灣",
    topic: "原料技術",
    title: "中國桂花驗出蘇丹紅！1700公斤全銷毀中國香料乾燥植物明年6/16前邊境逐批查驗- 營養好食 - 健康2.0",
    summary: "食品安全與品質與品質管控事件：'中國桂花驗出蘇丹紅！1700公斤全銷毀中國香料乾燥植物明年6/16前邊境逐批查驗- 營養好食 - 健康2.0'。事件提醒業界加強供應鏈檢驗。",
    impact: "此食安風險警示我方需加強審查原料供應商與生產品質管制，避免相似風險對商譽造成衝擊。",
    action: "盤點並抽檢主力產品之相關原料品保檢驗報告。",
    owner: "採購品保",
    source: "健康2.0",
    ...
    <main className="app-shell">
      ...
      <section className="workspace" id="top">
        ...
        <div className="newspaper-masthead">
          ...
          <div className="masthead-meta">
            <div className="date-line">
              <p className="eyebrow">2026年7月31日・星期五</p>
            </div>
        ...
        <div className="subline-bar">
          ...
          <div>最後更新：<time dateTime="2026-07-31T04:00:13+08:00">2026/07/31 04:00</time></div>
        </div>
        ...
        <section className="reputation-section">
          <div className="reputation-panel">
            <div className="reputation-intro">
              ...
              <h2>齋之味網路風評</h2>
              <p>每日 08:30 檢查公開評價與品牌提及；Google 評論最近查核：2026/07/31 04:00。</p>
            </div>
